          ...
          <div>
            ...
            <form onSubmit={handleSubscribe} className="relative">
              <input
                ...
                required
                className="w-full px-4 py-2.5 rounded-lg bg-white border border-gray-200 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-600 text-sm"
              />
              <button
                type="submit"
                className="absolute right-2 top-1/2 -translate-y-1/2 text-indigo-600 hover:text-indigo-700 transition-colors"
              >
                <Send size={18} />
              </button>
            </form>
            {subscribed && (
              <p className="text-xs text-indigo-600 mt-2">Thanks for subscribing!</p>
            )}
          </div>
        </div>
